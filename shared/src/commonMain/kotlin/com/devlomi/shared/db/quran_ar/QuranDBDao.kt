...
interface QuranDBDao {
    ...
    suspend fun searchForAyah(query: String): List<com.devlomi.shared.db.quran_ar.entities.VersesContentEntity>
    ...
    ): List<com.devlomi.shared.db.quran_ar.entities.ShareTextEntity>
}